...
export const requesttypeService = {
  ...
  return fetch(  `${apiUrl}${Masters}request`, requestOptions)
...
return fetch(  `${apiUrl}${Masters}request/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrl}${Masters}request/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleterequesttype(id) {
  ...
  return fetch(`${apiUrl}${Masters}request/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
...
export function fileUpload(file)
{
  ...
  var url = `${apiUrl}${Masters}request/bulkupload`
