...
export const reportService = {
  ...
  return fetch(  `${apiUrlMainline}${Mainline}${apiname}/report`, requestOptions)
...
return fetch(  `${apiUrlMainline}${Mainline}kpireport/report`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlMainline}${Mainline}areaselection/regionwise_multiple`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
