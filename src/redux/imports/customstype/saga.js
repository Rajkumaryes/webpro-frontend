...
export function fetchcustomstype() {
  ...
  return fetch(  `${apiUrlImport}${Import}customstype`, requestOptions)
...
return fetch(  `${apiUrl}${Import}customstype/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrl}${Import}customstype/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deletecustomstype(id) {
  ...
  return fetch(`${apiUrl}${Import}customstype/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
...
export function fileUpload(file)
{
  ...
  var url = `${apiUrl}${Import}customstype/bulkupload`
