...
export const reportService = {
  ...
  return fetch(  `${apiUrlTender}${Tender}productivityreport/report`, requestOptions)
...
export function fetchapikpi(page,per_page,startdate,enddate,user_array,is_report,
  username,menu,submenu,team_id,team,type) {
...
return fetch(  `${apiUrlTender}${Tender}kpireport/report`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
