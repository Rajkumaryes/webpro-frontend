...
export function fileUpload(file)
{
  ...
  var url = `${apiUrl}${PactKPI}errortype/bulkupload`
  ...
  return fetch(  `${apiUrl}${PactKPI}errortype`, requestOptions)
...
return fetch(  `${apiUrl}${PactKPI}errortype/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrl}${PactKPI}errortype/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrl}${PactKPI}errortype/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
