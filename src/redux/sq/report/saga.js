...
export const reportService = {
  ...
  return fetch(  `${apiUrl}${SQ}${apiname}/report`, requestOptions)
...
export function fetchapi1(apiname,page,per_page,startdate,enddate,user_array,is_report,
  username,menu,submenu,team_id,team,type) {
...
return fetch(  `${apiUrl}${SQ}${apiname}/controlscreen_report`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
