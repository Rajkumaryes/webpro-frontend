...
export const amendmentsService = {
  ...
  return fetch(  `${apiUrl}${RA}amendments`, requestOptions)
...
return fetch(  `${apiUrl}${RA}amendments/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrl}${RA}amendments/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrl}${RA}amendments/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
...
export function fileUpload(file)
{
  ...
  var url = `${apiUrl}${RA}amendments/bulkupload`
