...
export const sizeService = {
  ...
  return fetch(  `${apiUrlRA}${RA}size`, requestOptions)
...
return fetch(  `${apiUrlRA}${RA}size/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlRA}${RA}size/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrlRA}${RA}size/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
...
export function fileUpload(file)
{
  ...
  var url = `${apiUrlRA}${RA}size/bulkupload`
