...
export const regionsService = {
  ...
  return fetch(  `${apiUrlRA}${RA}region`, requestOptions)
...
return fetch(  `${apiUrlRA}${RA}region/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlRA}${RA}region/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrlRA}${RA}region/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
...
export function fileUpload(file)
{
  ...
  var url = `${apiUrlRA}${RA}region/bulkupload`
