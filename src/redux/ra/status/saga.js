...
export const statusService = {
  ...
  return fetch(  `${apiUrlRA}${RA}status`, requestOptions)
...
return fetch(  `${apiUrlRA}${RA}status/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlRA}${RA}status/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrlRA}${RA}status/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
...
export function fileUpload(file)
{
  ...
  var url = `${apiUrlRA}${RA}status/bulkupload`
