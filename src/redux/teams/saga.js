...
export const teamsService = {
  ...
  return fetch(  `${apiUrl}${Master_gateway}teams`, requestOptions)
...
export function updateteams(id,region,area,name,country_code,status) {
...
return fetch(  `${apiUrl}${Master_gateway}teams/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
