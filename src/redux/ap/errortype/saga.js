...
export function fileUpload(file)
{
  ...
  var url = `${apiUrlAP}${AP}errortype/bulkupload`
  ...
  return fetch(  `${apiUrlAP}${AP}errortype`, requestOptions)
...
return fetch(  `${apiUrlAP}${AP}errortype/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlAP}${AP}errortype/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrlAP}${AP}errortype/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
