...
export function fileUpload(file)
{
  ...
  var url = `${apiUrlAP}${AP}region/bulkupload`
  ...
  return fetch(  `${apiUrlAP}${AP}region`, requestOptions)
...
return fetch(  `${apiUrlAP}${AP}region/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlAP}${AP}region/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrlAP}${AP}region/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
