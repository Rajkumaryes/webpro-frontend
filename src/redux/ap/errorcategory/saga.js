...
export function fileUpload(file)
{
  ...
  var url = `${apiUrlAP}${AP}errorcategory/bulkupload`
  ...
  return fetch(  `${apiUrlAP}${AP}errorcategory`, requestOptions)
...
return fetch(  `${apiUrlAP}${AP}errorcategory/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlAP}${AP}errorcategory/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrlAP}${AP}errorcategory/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
