...
export const auditstatusService = {
  ...
  return fetch(  `${apiUrlAP}${AP}auditstatus`, requestOptions)
...
export function fileUpload(file)
{
  ...
  var url = `${apiUrlAP}${AP}auditstatus/bulkupload`
...
return fetch(  `${apiUrlAP}${AP}auditstatus/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlAP}${AP}auditstatus/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrlAP}${AP}auditstatus/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
