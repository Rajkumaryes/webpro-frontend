...
export const reportService = {
  ...
  return fetch(  `${apiUrlBchteam}${Bchteam}${apiname}/report`, requestOptions)
...
return fetch(  `${apiUrlBchteam}${Bchteam}${apiname}/omnicasehandlingdashboard`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlBchteam}${Bchteam}${apiname}/download`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlBchteam}${Bchteam}${apiname}/reportprocesswise`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrlBchteam}${Bchteam}kpireport/report`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
