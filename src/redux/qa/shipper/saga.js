...
export const shipperService = {
  ...
  return fetch(  `${apiUrl}${QA}shipper`, requestOptions)
...
return fetch(  `${apiUrl}${QA}shipper/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrl}${QA}shipper/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrl}${QA}shipper/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
...
export function fileUpload(file)
{
  ...
  var url = `${apiUrl}${QA}shipper/bulkupload`
