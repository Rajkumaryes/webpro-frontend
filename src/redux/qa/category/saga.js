...
export const categoryService = {
  ...
  return fetch(  `${apiUrl}${QA}category`, requestOptions)
...
return fetch(  `${apiUrl}${QA}category/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrl}${QA}category/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrl}${QA}category/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
...
export function fileUpload(file)
{
  ...
  var url = `${apiUrl}${QA}category/bulkupload`
