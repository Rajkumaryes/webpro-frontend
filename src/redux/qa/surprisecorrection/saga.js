...
export const surprisecorrectionService = {
  fetchapi,
  createapi,
  updateapi,
  deleteapi,
  ...
  return fetch(  `${apiUrl}${QA}surprisecorrection`, requestOptions)
...
return fetch(  `${apiUrl}${QA}surprisecorrection/create`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
return fetch(  `${apiUrl}${QA}surprisecorrection/update/${id}`, requestOptions)
.then(response => response.json())
.then(user => { 
    return user;
    }) 
...
function deleteapi(id) {
  ...
  return fetch(`${apiUrl}${QA}surprisecorrection/delete/${id}`, requestOptions)
  .then(response => response.json())
  .then(user => {  
      return user;
      }) 
