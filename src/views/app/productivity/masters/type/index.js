...
class MasterPage extends Component {
  ...
  renderTemplate()
  {
    ...
    var array = data.map(record=> {
      ...
            })
    return(
      <Workbook filename="Type.xlsx" element={<Button  className = "button-width" color="secondary">
    ...
    return (
        ...
        >
          <ModalHeader toggle={()=>this.closeModal()}>
              {isEdit ? onChangeLanguage(locale,'Update Type',languageData) : onChangeLanguage(locale,'Create Type',languageData)}   
          </ModalHeader>
          <ModalBody>
