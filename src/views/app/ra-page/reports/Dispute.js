  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize
            ,area_data,status_data} = this.state
        var columns =  [
            {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Dispute Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Dispute Raw Data',languageData)} match={match} />
