...
class MasterPage extends Component {
  ...
  renderTemplate()
  {
    ...
    const {data,region_data,size_data} = this.state
    var array = data.map(record=> {
                return {
                  ...
                  'Type of request' : record.typeofreq ,
                  'Route Service' : record.name ,
                  'Size' :record.size !== null ?getValue(size_data,'value','text',record.size) :'',
                  'Eq' : record.eq,
              };
            })
    return(
      <Workbook filename="EQ.xlsx" element={<Button  className = "button-width" color="secondary">
      ...
      <Workbook.Column label="Activity Type" value="Activity Type"/>
      <Workbook.Column label="Type of request" value="Type of request"/>
      <Workbook.Column label="Route Service" value="Route Service"/>
          ...
          },
             {
              ...
              },
              {
                ...
                render: (text, record) => (	
                  ...
                  ...this.getColumnSearchProps('typeofreq')
              },
              {
                title:  onChangeLanguage(locale,'Route Service',languageData),
                dataIndex: 'name',
                key: 'name',
              ...
              },
              {
                ...
                render: (text, record) => (	
                  <div>
                     {text !== null &&getValue(size_data,'value','text',text)}
                  </div>
              ),
              filters: size_data,
              filterMultiple: false,
                    ...
                    <div className = "col-md-8">
                     ...
                     <div className = "col-md-4">
                      ...
                      <Button color = "primary"  className = 'fontstyle button-width' onClick ={(event) => this.openModal()}>
                        {onChangeLanguage(locale,' Add EQ Master',languageData)}
                      </Button>
                    </div>
    ...
    return (
        ...
        >
          <ModalHeader toggle={()=>this.closeModal()}>
              {isEdit ? 'Update EQ Master' : 'Create EQ Master'}   
          </ModalHeader>
          <ModalBody>
