...
createAPI(name,status)
{
  ...
  ActivityselectionService.createactivityselection(name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,status)
{
  ...
  ActivityselectionService.updateactivityselection(id,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
      ...
      <div>
          ...
          <div>
            ...
            <Colxx xxs="8" className="mb-4">
                  <Input 
                        type="text"
                        placeholder = {onChangeLanguage(locale,'Activity Selection',languageData)} 
                        value = {name}  
