...
class MasterPage extends Component {
  ...
  handleDelete = id => {
    ErrortypeService.deleteerrortype(id)
    .then((res) => {
      if(res){
...
      })
      return(
        ...
        <Workbook filename="Error Type.xlsx" element={
          ...
          <Workbook.Column label="Error Type Name" value="name"/>
          <Workbook.Column label="Sensitivity" value="sensitivity"/>
          </Workbook.Sheet> 
        </Workbook>
        ...
        const columns = [
             {
              ...
              },
              {
                ...
                key: 'sensitivity',
                ...this.getColumnSearchProps('sensitivity')
              },
              {
    ...
    return (
        ...
        >
          <ModalHeader toggle={()=>this.closeModal()}>
              {isEdit ? 'Update Error Type' : 'Create Error Type'}   
          </ModalHeader>
          <ModalBody>
