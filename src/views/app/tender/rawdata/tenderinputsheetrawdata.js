...
import{reportService} from '../../../../redux/tender/tenderinputsheetrawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          tendercategorydata,sectiondata,subsectiondata,areacodedata,tendernamedata,rounddata,
          typeoftenderdata,activitydata,area_data} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Mail Received Date',languageData),
            dataIndex: 'mail_receiveddate',
            key: 'mail_receiveddate',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Task action date',languageData),
            dataIndex: 'tender_actiondate',
            key: 'tender_actiondate',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {(text !== null && text !== '')  && moment(text).format('MM/DD/YYYY hh:mm:ss a')}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Tender Category(GTM/Area)',languageData),
            dataIndex: 'tender_category',
            key: 'tender_category',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Lane Count',languageData),
            dataIndex: 'lane_count',
            key: 'lane_count',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
          ...
          {
            title: onChangeLanguage(locale,'Type Of Tender',languageData),
            dataIndex: 'typeof_tender',
            key: 'typeof_tender',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(typeoftenderdata,'value','label',text)}
              </div>),           
          },
          {
          ...
          {
            title: onChangeLanguage(locale,'Number of Response Actioned',languageData),
            dataIndex: 'no_of_responseactioned',
            key: 'no_of_responseactioned',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Validity Start',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Validity End',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Bid Volume TEU',languageData),
            dataIndex: 'bitvolume',
            key: 'bitvolume',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Account Manager',languageData),
          ...
          {
            title: onChangeLanguage(locale,'GTM POE',languageData),
            dataIndex: 'gtmpoe',
            key: 'gtmpoe',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Tender Feedback',languageData),
            dataIndex: 'tender_feedback',
            key: 'tender_feedback',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Query Start date',languageData),
            dataIndex: 'query_startdate',
            key: 'query_startdate',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {(text !== null && text !== '')  && moment(text).format('MM/DD/YYYY hh:mm:ss a')} 
          ...
          {
            title: onChangeLanguage(locale,'Query End date',languageData),
            dataIndex: 'query_enddate',
            key: 'query_enddate',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
              {(text !== null && text !== '')  && moment(text).format('MM/DD/YYYY hh:mm:ss a')} 
          ...
          {
            title: onChangeLanguage(locale,'Past Performance Volume',languageData),
            dataIndex: 'past_performance',
          ...
          {
            title: onChangeLanguage(locale,'Mail sent date',languageData),
            dataIndex: 'mail_sentdate',
            key: 'mail_sentdate',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Tender Input Sheet Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Tender Input Sheet Raw Data',languageData)} match={match} />
