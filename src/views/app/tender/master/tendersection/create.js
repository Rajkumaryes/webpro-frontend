...
handlechangeactivity = (selectedOptions) => {
  ...
  const {activitydata,subactivitydata,activity}=this.state
  let value =selectedOptions.value
  
  this.setState({
    activity : selectedOptions.value,
    is_subactivity:getValue(activitydata,'value','label',value),
  })
      ...
      <div>
        ...
        <Row>
            ...
            <Colxx xxs="8" className="mb-4">
             ...
             <Row>
              <Colxx xxs="4" className="mb-4">
                   <Label> {onChangeLanguage(locale,'Sub Section',languageData)}</Label>
              </Colxx>
              <Colxx xxs="8" className="mb-4">
                       <Input 
                        type="text"
