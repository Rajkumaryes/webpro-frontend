  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          typedata,reportdata} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Reports',languageData),
            dataIndex: 'activity',
            key: 'activity',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Reports Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Reports Raw Data',languageData)} match={match} />
