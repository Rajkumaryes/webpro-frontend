  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          typedata,activitydata} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Ramp/Region',languageData),
            dataIndex: 'region',
            key: 'region',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}> 
          ...
          {
            title: onChangeLanguage(locale,'Processed Date',languageData),
          ...
          },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
             {getValue(typedata,'value','label',text)}  
              </div>),           
          },
          {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Others Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Others Raw Data',languageData)} match={match} />
