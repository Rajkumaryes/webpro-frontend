  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Announced by',languageData),
            dataIndex: 'announced_by',
            key: 'announced_by',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
                {text}   
          ...
          {
            title: onChangeLanguage(locale,'Cross Town',languageData),
            dataIndex: 'cross_town',
            key: 'cross_town',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {(text !== null && text !== '')  && moment(text).format(' hh:mm:ss a')}
              </div>),           
          },
          {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Announcement Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Announcement Raw Data',languageData)} match={match} />
