...
import{reportService} from '../../../../redux/railnotification/reportrawdata/saga'
    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url =  'container',
            menu= 'Rail Notification' , 
            submenu='Container Release Data',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Arrival MOT',languageData),
            dataIndex: 'arrival_mot',
            key: 'arrival_mot',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Pickup Number',languageData),
          ...
          {
            title: onChangeLanguage(locale,'LFD',languageData),
            dataIndex: 'lfd',
            key: 'lfd',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Movement',languageData),
            dataIndex: 'movement',
            key: 'movement',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          },
          {
            ...
            dataIndex: 'completed_update',
            key: 'completed_update',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
           {text}
         </div>),           
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Container Release Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Container Release Raw Data',languageData)} match={match} />
