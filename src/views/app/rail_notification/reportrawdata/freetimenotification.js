    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url =  'freetime',
            menu= 'Rail Notification' , 
            submenu='Free Time Notification',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Last Update Time In FIS',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Completed Update Time In FIS',languageData),
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Free Time Notification Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Free Time Notification Raw Data',languageData)} match={match} />
