...
class MasterPage extends Component {
  ...
  renderTemplate()
  {
    ...
    const {data,type_data} = this.state
    var array = data.map(record=> {
          return {
            'module' : record.module,
            'eq' : record.eq,
            'type' :getValue(type_data,'value','text', record.type),
        };
      })
      return(
        ...
        <Workbook filename="EQ.xlsx" element={
          ...
          <Workbook.Column label="Name" value="module"/>
        ...
        const columns = [
             {
              ...
              },
              {
                ...
                <span className="row d-flex justify-content-center">                             
                      {getValue(type_data,'value','text', text)}
                </span>
                 ),   
                 filters: type_data,
              ...
              <Colxx xxs="12">
                <div className = "row">
                    ...
                    <Button className = "button-width" color="primary">
                            ...
                            <input type="file" module="file" id="File-1" onClick ={(e) => e.target.value=null }
