...
      })
      return(
        ...
        <Workbook filename="Customs Type.xlsx" element={
          ...
          <Workbook.Column label="Customs Type" value="name"/>
          </Workbook.Sheet> 
        </Workbook>
  ...
  onChangeFileUpload(files)
    ...
    customtypeService.fileUpload(files[0])
      .then((res) => { 
        if(res.status)
        {  this.setState({
          loading : false
  ...
  handleReset = clearFilters => {
    ...
    render()
    {
      const {locale,languageData,match} = this.props
        ...
        return (
            <>
            <title> {onChangeLanguage(locale,'Customs Type',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <div className = "row">
                    <div className = "col-md-7">
                        <Breadcrumb heading= {onChangeLanguage(locale,'Customs Type',languageData)} match={match} />
                    </div>
                    ...
                    <Button className = "button-width" color="primary">
                       ...
                       <Button color = "primary"  className = 'fontstyle button-width' onClick ={(event) => this.openModal()}>
                        {onChangeLanguage(locale,'Add Customs Type',languageData)}
                      </Button>
                    </div>
    ...
    renderModal()
  {
    ...
    return (
        ...
        >
         ...
         {isEdit ? onChangeLanguage(locale,'Update Customs Type' , languageData) : onChangeLanguage(locale,'Create Customs Type' , languageData) }   
          </ModalHeader>
          <ModalBody>
