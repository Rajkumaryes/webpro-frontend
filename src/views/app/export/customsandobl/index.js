...
class Sidebar extends Component {
    ...
    render() {
        const { user_id, start_time, end_time, crmcasehandlingcount,crmcasehandlingcountlast,
         ...
         team, teamdata,areadata,area,listviewdata,listview,statusofcasedata,statusofcase,received_time,activitydata,activity,  loading,   is_submit, is_search,activeTab } = this.state
        const { match, languageData, locale, username } = this.props
        return (
            <>
                <title>{onChangeLanguage(locale, 'Customs and OBL', languageData)}</title>
                {loading &&
                    <div>
                    ...
                    <Colxx xxs="12">
                        ...
                        <div className="row">
                            <div className="col-md-8">
                                <Breadcrumb heading={onChangeLanguage(locale, 'Customs and OBL', languageData)} match={match} />
                            </div>
  ...
  >
    ...
    <Tab
      ...
      title={
        <div
          className={`custom-tab ${activeTab === 'customs' ? 'active' : ''}`}
          style={{
            textAlign: 'center', 
            padding: '10px', 
            fontSize: '1.2rem', 
    ...
    >
                ...
                <Tab
                    ...
                    title={
                        <div
                        className={`custom-tab ${activeTab === 'obl' ? 'active' : ''}`}
                        style={{
                            textAlign: 'center', 
                            padding: '10px', 
                            fontSize: '1.2rem', 
