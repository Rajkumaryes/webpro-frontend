          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'codexception',
            menu= 'Export' , 
            submenu='COD & Exception',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Dates',languageData),
            dataIndex: 'dates',
            key: 'dates',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Times',languageData),
            dataIndex: 'times',
            key: 'times',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Organization Code',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Issue Time',languageData),
          ...
          },
          {
            ...
            dataIndex: 'exception_number',
            key: 'exception_number',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'COD & Exception Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'COD & Exception Raw Data',languageData)} match={match} />
