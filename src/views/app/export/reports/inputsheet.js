  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Audit Sheet',languageData),
            dataIndex: 'auditsheet',
            key: 'auditsheet',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
                {text === true && 'TRUE'} 
          ...
          {
            title: onChangeLanguage(locale,'Aggregate Status',languageData),
            dataIndex: 'aggregate_status',
            key: 'aggregate_status',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'BOT',languageData),
            dataIndex: 'bot_activity',
            key: 'bot_activity',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'DPRE',languageData),
            dataIndex: 'dpre',
            key: 'dpre',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Input Sheet Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Input Sheet Raw Data',languageData)} match={match} />
