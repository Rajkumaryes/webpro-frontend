  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          checklist_data,regiondata} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Regions',languageData),
            dataIndex: 'regions',
            key: 'regions',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Indexing',languageData),
            dataIndex: 'indexing',
            key: 'indexing',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Reminders / E-mail',languageData),
            dataIndex: 'reminders',
            key: 'reminders',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'SI Reminder Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'SI Reminder Raw Data',languageData)} match={match} />
