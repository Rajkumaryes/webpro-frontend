...
class QueryResolveSheet extends Component {
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,teamdata} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'MTD Count',languageData),
            dataIndex: 'mtd',
            key: 'mtd',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Actualization',languageData),
            dataIndex: 'actualization',
            key: 'actualization',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'ATD Date & Timing(IST)',languageData),
            dataIndex: 'atd_date_time',
            key: 'atd_date_time',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
                {text}   
          ...
          {
            title: onChangeLanguage(locale,'GST Mail Sent Date & Time',languageData),
            dataIndex: 'gst_date_time',
            key: 'gst_date_time',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
                {text}   
          ...
          {
            title: onChangeLanguage(locale,'MSDC Pulled Date & Time',languageData),
            dataIndex: 'msdc_date_time',
            key: 'msdc_date_time',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}   
          ...
          {
            title: onChangeLanguage(locale,'GST Confirmation Received Date & Time',languageData),
            dataIndex: 'gstrec_date_time',
            key: 'gstrec_date_time',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
                 {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'F0030 Date & Time',languageData),
            dataIndex: 'foo_date_time',
            key: 'foo_date_time',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}  
          ...
          {
            title: onChangeLanguage(locale,'Final Status Sent Date & Time',languageData),
            dataIndex: 'final_date_time',
            key: 'final_date_time',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
              {text}    
          ...
          {
            title: onChangeLanguage(locale,'Time Taken From ATD to GST Mail Sent',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Task',languageData),
            dataIndex: 'task',
            key: 'task',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Release Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Release Raw Data',languageData)} match={match} />
