          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'queryresolvesheet',
            menu= 'Export' , 
            submenu='Query Resolve Sheet',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'CR',languageData),
            dataIndex: 'cr',
            key: 'cr',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'AP',languageData),
            dataIndex: 'ap',
            key: 'ap',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Issue Org',languageData),
            dataIndex: 'issue_org',
            key: 'issue_org',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Iss User ID',languageData),
            dataIndex: 'iss_userid',
            key: 'iss_userid',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'User / Group',languageData),
            dataIndex: 'user',
            key: 'user',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Receiver Status',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Created At',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Closed',languageData),
            dataIndex: 'closed',
            key: 'closed',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Query Resolve Sheet Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Query Resolve Sheet Raw Data',languageData)} match={match} />
