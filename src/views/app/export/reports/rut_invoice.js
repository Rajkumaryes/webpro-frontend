...
class QueryResolveSheet extends Component {
          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'rutinvoice',
            menu= 'Export' , 
            submenu='RUT, Invoice & SDC',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'RUT, Invoice & SDC Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'RUT, Invoice & SDC Raw Data',languageData)} match={match} />
