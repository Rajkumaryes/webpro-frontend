          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'errormodule',
            menu= 'Export' , 
            submenu='Error Module',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Invoice No (For INVS)',languageData),
          ...
          },
          {
            ...
            dataIndex: 'error_code_group',
            key: 'error_code_group',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Error/Reason code',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Correction/Audit Recd Date',languageData),
            dataIndex: 'recd_date',
            key: 'recd_date',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Correction/Audit Recd DateError Capturing User ID',languageData),
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Error Module Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Error Module Raw Data',languageData)} match={match} />
