...
class QueryResolveSheet extends Component {
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        teamdata,typeofotdata} = this.state
        var columns= [
          {
          ...
          },
          {
            ...
            dataIndex: 'type_of_ot',
            key: 'type_of_ot',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(typeofotdata,'value','label',text)}    
              </div>),           
          },
          {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'OT Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'OT Raw Data',languageData)} match={match} />
