...
import{reportService} from '../../../../redux/Dispute-process/invoice-cancellationrawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Invoice',languageData),
            dataIndex: 'invoice',
            key: 'invoice',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Document',languageData),
            dataIndex: 'document',
            key: 'document',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Dispute',languageData),
            dataIndex: 'dispute',
            key: 'dispute',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Phase',languageData),
            dataIndex: 'phase',
            key: 'phase',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Collection Reference',languageData),
            dataIndex: 'collection_ref',
            key: 'collection_ref',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Invoice Cancellation Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Invoice Cancellation Raw Data',languageData)} match={match} />
