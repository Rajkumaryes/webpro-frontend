...
import{reportService} from '../../../../redux/Dispute-process/error-capturingrawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          teamdata,prepaiddata,countrydata,processdata,errortypedata} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Original Invoice No',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Re-Invoice No',languageData),
            dataIndex: 'reinvoice_no',
            key: 'reinvoice_no',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Re-Invoice Date',languageData),
            dataIndex: 'reinvoice_date',
            key: 'reinvoice_date',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Cancellation Reason Code',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Dispute Capture Code',languageData),
            dataIndex: 'dispute_capture',
            key: 'dispute_capture',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Prepaid / Collect',languageData),
            dataIndex: 'prepaid',
            key: 'prepaid',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
              {getValue(prepaiddata,'value','label',text)}     
              </div>),           
          },
          {
          ...
          {
            title: onChangeLanguage(locale,'Error Marked By User',languageData),
            dataIndex: 'error_marked',
            key: 'error_marked',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Error Received By User',languageData),
            dataIndex: 'error_receiveduser',
            key: 'error_receiveduser',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Error Captured Date / Time',languageData),
            dataIndex: 'error_receiveddate',
            key: 'error_receiveddate',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Error Capture Module Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Error Capture Module Raw Data',languageData)} match={match} />
