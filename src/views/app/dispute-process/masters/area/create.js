...
onSubmit() { 
  const {id,name,status,isEdit,region} = this.state;
...
createAPI(region,name,status)
{
  ...
  areaService.createarea(region,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,region,name,status)
{
  ...
  areaService.updatearea(id,region,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
onChangeRegion(value)
{
  ...
  render()
  {
    ...
    const {region,name,region_data,isEdit,status,loading} = this.state
