...
      })
      return(
        ...
        <Workbook filename="Dispute Status.xlsx" element={
          ...
          <Workbook.Column label="Dispute Status" value="name"/>
          </Workbook.Sheet> 
        </Workbook>
  ...
  handleReset = clearFilters => {
    ...
    render()
    {
      const {locale,languageData,match} = this.props
        ...
        return (
            <>
            <title> {onChangeLanguage(locale,'Dispute Status',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <div className = "row">
                    <div className = "col-md-7">
                        <Breadcrumb heading= {onChangeLanguage(locale,'Dispute Status',languageData)} match={match} />
                    </div>
    ...
    return (
        ...
        >
          <ModalHeader toggle={()=>this.closeModal()}>
              {isEdit ? 'Update Dispute Status' : 'Create Dispute Status'}   
          </ModalHeader>
          <ModalBody>
