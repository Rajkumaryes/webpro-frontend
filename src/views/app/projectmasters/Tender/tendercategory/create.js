...
createAPI(name,status)
{
  ...
  tendercategoryService.createtendercategory(name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,status)
{
  ...
  tendercategoryService.updatetendercategory(id,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
      ...
      <div>
          ...
          <div>
            ...
            <Colxx xxs="8" className="mb-4">
                  <Input 
                        type="text"
                        placeholder = {onChangeLanguage(locale,'Category',languageData)} 
                        value = {name}  
