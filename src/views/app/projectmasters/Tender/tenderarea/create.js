...
close(isedit)
{
  ...
  render()
  {
    ...
    const {name,isEdit,code,status,loading,area_data,region_data} = this.state
      ...
      <div>
         ...
         <Row>
            ...
            <Select  
                        ...
                        value={region_data.filter(option =>option.value === code)}
                        options={region_data}
            ...
            <Select  
                        ...
                        classNamePrefix="react-select"
                        name="form-field-name"
                        value={area_data.filter(option =>option.value === name)}
                        options={area_data}
