...
import{reasonsService} from '../../../../redux/projectmasters/reasons/saga'
class MasterPage extends Component {
  ...
  handleDelete = id => {
    reasonsService.deletereasons(id)
    .then((res) => {
      if(res){
    ...
    return (
        ...
        >
          <ModalHeader toggle={()=>this.closeModal()}>
              {isEdit ? 'Update Reasons' : 'Create Reasons'}   
          </ModalHeader>
          <ModalBody>
