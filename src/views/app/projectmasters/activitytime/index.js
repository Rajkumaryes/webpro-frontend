...
import{activitytimeService} from '../../../../redux/projectmasters/activitytime/saga'
...
class MasterPage extends Component {
  ...
  handleDelete = id => {
    activitytimeService.deleteactivitytime(id)
    .then((res) => {
      if(res){
...
      })
  ...
  onChangeFileUpload(files)
    ...
    activitytimeService.fileUpload(files[0])
      .then((res) => { 
        if(res.status)
        {
          if(res.data.status)   
              ...
              <Colxx xxs="12">
                <div className = "row">
                    <div className = "col-md-7">
                        <Breadcrumb heading= {onChangeLanguage(locale,'Activity (Time Pending Monitoring)',languageData)} match={match} />
                    </div>
