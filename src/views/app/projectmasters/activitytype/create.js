...
createAPI(name,status)
{
  ...
  activitytypeService.createactivitytype(name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,status)
{
  ...
  activitytypeService.updateactivitytype(id,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
      ...
      <div>
          ...
          <div>
            ...
            <Colxx xxs="8" className="mb-4">
                  <Input 
                        type="text"
                        placeholder = {onChangeLanguage(locale,'Activity Type',languageData)} 
                        value = {name}  
