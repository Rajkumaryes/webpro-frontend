...
onSubmit() { 
  const {id,name,area_id,status,isEdit} = this.state;

  if(name !== "")
  {
    if(isEdit === true)
    {
      this.updateAPI(id,name,area_id,status)
    }
    else
    {
      this.createAPI(name,area_id,status)
    }
...
createAPI(name,area_id,status)
{
  this.setState({
    loading : true
  })
  subareaService.createsubarea(name,area_id,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,area_id,status)
{
  this.setState({
    loading : true
  })
  subareaService.updatesubarea(id,name,area_id,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
close(isedit)
{
  ...
  render()
  {
    ...
    const {name,area_id,areadata,isEdit,status,loading} = this.state
