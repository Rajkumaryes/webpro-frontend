...
createAPI(region_id,area_name,status)
{
  ...
  areaService.createarea(region_id,area_name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,region_id,area_name,status)
{
  ...
  areaService.updatearea(id,region_id,area_name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
close(isedit)
{
  ...
  render()
  {
    ...
    const {region_id,area_name,region_data,isEdit,status,loading} = this.state
