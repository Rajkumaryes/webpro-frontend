...
import{areastreetService} from '../../../../redux/projectmasters/areastreet/saga';
class MasterPage extends Component {
    ...
    fetchData() {  
      ...
      areastreetService.fetchareastreet()
        .then((res) => { 
          this.setState({   
        loading : false 
  ...
  handleDelete = id => {
    areastreetService.deleteareastreet(id)
    .then((res) => {
      if(res){
              ...
              <Colxx xxs="12">
                <div className = "row">
                    <div className = "col-md-10">
                        <Breadcrumb heading= {onChangeLanguage(locale,'Area (Street Turns)',languageData)} match={match} />
                    </div>
