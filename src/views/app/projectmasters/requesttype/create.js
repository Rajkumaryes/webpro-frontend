...
import{requesttypeService} from '../../../../redux/projectmasters/requesttype/saga'
...
createAPI(name,status)
{
  ...
  requesttypeService.createrequesttype(name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,status)
{
  ...
  requesttypeService.updaterequesttype(id,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
