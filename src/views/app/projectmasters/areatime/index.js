...
class MasterPage extends Component {
  ...
  handleDelete = id => {
    areatimeService.deleteareatime(id)
    .then((res) => {
      if(res){
              ...
              <Colxx xxs="12">
                <div className = "row">
                    <div className = "col-md-10">
                        <Breadcrumb heading= {onChangeLanguage(locale,'Area (Time Pending Monitoring)',languageData)} match={match} />
                    </div>
