...
onSubmit() { 
  ...
  if(area !== "")
  {
    if(isEdit === true)
    {
      this.updateAPI(id,area,name,status)
    }
    else
    {
      this.createAPI(area,name,status)
    }
...
createAPI(area,name,status)
{
  this.setState({
    loading : true
  })
  stturncodeService.createstturncode(area,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,area,name,status)
{
  this.setState({
    loading : true
  })
  stturncodeService.updatestturncode(id,area,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
close(isedit)
{
  ...
  render()
  {
    ...
    const {area,name,isEdit,status,loading} = this.state
