...
import { typeofotService } from '../../../../redux/projectmasters/typeofot/saga';
                ...
                <div className = "row">
                    ...
                    <Button className = "button-width" color="primary">
                       ...
                       <Button color = "primary"  className = 'fontstyle button-width' onClick ={(event) => this.openModal()}>
                        {onChangeLanguage(locale,' Add Typeof OT',languageData)}
                      </Button>
                    </div>
    ...
    return (
        ...
        >
          <ModalHeader toggle={()=>this.closeModal()}>
              {isEdit ? 'Update Type of OT' : 'Create Type of OT'}   
          </ModalHeader>
          <ModalBody>
