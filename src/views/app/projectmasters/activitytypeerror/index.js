...
import{activitytypeerrorService} from '../../../../redux/projectmasters/activitytypeerror/saga';
...
class MasterPage extends Component {
  ...
  handleDelete = id => {
    activitytypeerrorService.deleteactivitytypeerror(id)
    .then((res) => {
      if(res){
...
      })
      return(
        ...
        <Workbook filename="Activity.xlsx" element={
          ...
          <Workbook.Column label="Activtytype" value="name"/>
          </Workbook.Sheet> 
        </Workbook>
  ...
  onChangeFileUpload(files)
    ...
    activitytypeerrorService.fileUpload(files[0])
      .then((res) => { 
        if(res.status)
        {
          if(res.data.status)   
