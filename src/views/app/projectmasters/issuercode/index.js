...
import{issuecodeService} from '../../../../redux/projectmasters/issuercode/saga';
...
class MasterPage extends Component {
  ...
  handleDelete = id => {
    issuecodeService.deleteissuecode(id)
    .then((res) => {
      if(res){
...
          return {
            ...
            'team' : record.team !== null &&getValue(team_data,'value','label',record.team ),
        ...
        const columns = [
             {
              ...
              },
              {
                ...
                render: (text, record) => (	
                  <div>
                     {text !== null &&getValue(team_data,'value','label',text)}
                  </div>
              ),
              },
              {
    ...
    return (
        ...
        >
          <ModalHeader toggle={()=>this.closeModal()}>
              {isEdit ? 'Update Issuer Code' : 'Create Issuer Code'}   
          </ModalHeader>
          <ModalBody>
