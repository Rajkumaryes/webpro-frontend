...
createAPI(name,region,status)
{
  ...
  regionService.createregion(name,region,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,region,status)
{
  ...
  regionService.updateregion(id,name,region,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
close(isedit)
{
  ...
  render()
  {
    ...
    const {name,region,isEdit,status,loading} = this.state
        ...
        <Row>
            ...
            <Colxx xxs="8" className="mb-4">
                  <Input 
                        ...
                        value = {region}  
                        onChange= {(e)=>this.setState({region : e.target.value})} ></Input>
                 </Colxx>
             </Row>
             <Row>
              <Colxx xxs="4" className="mb-4">
