...
import {onChangeLanguage,getValue,getTimeDifference,convertUTCToLocalDate,convertLocalToUTCDate} from '../../../../helper';
...
class QueryResolveSheet extends Component {
   ...
   setValue(record) 
    ...
    render()
    {
        ...
        const { loading,data, request_no, quotation_no,  amd_no,type_of_req,is_submit_table,
            received_time, priority, size, publisher, area, area_data,is_adimin_Edit,
            user_data,status_data, priority_data,size_data,dynamic_columns,typeofrequestdata,publisher_status} = this.state
            var columns = [
                  {
            ...
            <Row>
              ...
              <div className = "row">
                    ...
                    <div className = "publishuser-card-component" style = {{borderRadius:'10px',marginBottom:'30px'}}>
                          ...
                          <div className = "col-md-2 space-margin"  >
                            <Label  className = "fontstyle normal-font" >{onChangeLanguage(locale,'Quotation Number',languageData)}</Label>
                            <Input  className = "fontstyle text-background"  
                            placeholder = ''
                            value = {quotation_no}  
                            disabled = {true}  
                        ...
                        <div className = "col-md-2 space-margin"  >
                            ...
                            <Input  className = "fontstyle text-background"  
                            placeholder = ''
                            value = {getValue(typeofrequestdata,'value','label',type_of_req)}
                            disabled = {true} 
                            />
                        </div>
                                    ...
                                    <tr>
                                          ...
                                          {data && data.map((value,index) =>
                                                ...
                                                <Input  className = "fontstyle text-background" style = {{width:'135px',fontSize:'10px'}}  
                                                      ...
                                                      // onKeyDown ={(e)=>this.onKeyDownValue_row(e,value,key2)} 
...
const mapStateToProps = ({ settings,menu }) => {
      ...
      return {locale, languageData, selectedMenuHasSubItems};
};
