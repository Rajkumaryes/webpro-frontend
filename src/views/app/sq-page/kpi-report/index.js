...
import{reportService} from '../../../../redux/sq/productivityreport/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Received High',languageData),
            dataIndex: 'received_HIGH',
            key: 'received_HIGH',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Received STD',languageData),
            dataIndex: 'received_STD',
            key: 'received_STD',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
          ...
          {
            title: onChangeLanguage(locale,'Received Total',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Processed High',languageData),
            dataIndex: 'processed_HIGH',
            key: 'processed_HIGH',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Processed STD',languageData),
            dataIndex: 'processed_STD',
            key: 'processed_STD',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Processed Total',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Queried Count Total',languageData),
            dataIndex: 'queried_Count_Total',
            key: 'queried_Count_Total',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'OOT HIGH',languageData),
            dataIndex: 'ooT_HIGH',
            key: 'ooT_HIGH',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'OOT STD',languageData),
            dataIndex: 'ooT_STD',
            key: 'ooT_STD',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'OOT Total',languageData),
            dataIndex: 'ooT_TOTAL',
            key: 'ooT_TOTAL',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Services Received HIGH',languageData),
            dataIndex: 'services_Received_HIGH',
            key: 'services_Received_HIGH',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Services Received STD',languageData),
            dataIndex: 'services_Received_STD',
            key: 'services_Received_STD',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Services Received TOTAL',languageData),
            dataIndex: 'services_Received_TOTAL',
            key: 'services_Received_TOTAL',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Services Processed HIGH',languageData),
            dataIndex: 'services_Processed_HIGH',
            key: 'services_Processed_HIGH',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Services Processed STD',languageData),
            dataIndex: 'services_Processed_STD',
            key: 'services_Processed_STD',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Services Processed TOTAL',languageData),
            dataIndex: 'services_Processed_TOTAL',
            key: 'services_Processed_TOTAL',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Services Queried Count Total',languageData),
            dataIndex: 'services_Queried_Count_Total',
            key: 'services_Queried_Count_Total',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'External Error',languageData),
            dataIndex: 'external_Error',
            key: 'external_Error',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
          ...
          {
            title: onChangeLanguage(locale,'Internal Error',languageData),
            dataIndex: 'internal_Error',
            key: 'internal_Error',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
