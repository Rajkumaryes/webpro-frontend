...
import {onChangeLanguage,GetMinutes,GetHours} from '../../../../../helper'
...
onSubmit() { 
  ...
  if(region !== "" && name !=='' && start_time !== '' && end_time !== '' 
    && range1!== "" &&range2 !== "" && start_time1 !== "" && end_time1 !== "" && range1_currentday !=='')
  {
...
createAPI(region,name,status,start_time,end_time,range1,range2,start_time1,end_time1,range1_currentday)
{
  ...
  SQareaService.createarea(region,name,status,start_time,end_time,range1,range2,start_time1,end_time1,range1_currentday)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,region,name,status,start_time,end_time,range1,range2,start_time1,end_time1,range1_currentday)
{
  ...
  SQareaService.updatearea(id,region,name,status,start_time,end_time,range1,range2,start_time1,end_time1,range1_currentday)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
onChangestarttime(timeString)
  ...
  render()
  {
    ...
    const {region,name,region_data,area_data,isEdit,status,loading,start_time,end_time,
      ...
      <div>
        ...
        <Row>
            ...
            <TimePicker className = "fontstyle text-background" 
                    ...
                    //  onChange= {(timeString)=>this.setState({end_time : timeString})}  
            ...
            <TimePicker className = "fontstyle text-background" 
                    ...
                    //  onChange= {(timeString)=>this.setState({start_time : timeString})} 
                     ...
                     />
                  {/* <Input 
                        id="time" type="time" name="appt-time" step="2"
                        min="12:00" max="18:00"
                        placeholder = {onChangeLanguage(locale,'Range1 Start Time',languageData)} 
                        value = {start_time}  
                        onChange= {(e)=>this.setState({start_time : e.target.value,end_time:''})} ></Input> */}
                 </Colxx>
