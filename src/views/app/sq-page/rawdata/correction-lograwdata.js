...
import{reportService} from '../../../../redux/sq/report/saga'
    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url =  'correctionlog',
            menu= 'SQ' , 
            submenu='Correction Log',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
            internalexternal_data,area_data,region_data,errortype_data,status_data} = this.state
        var columns =  [
            {
            ...
            },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
            {getValue(internalexternal_data,'value','label',text)} 
            
              </div>),
          },
          // {
          //   title:onChangeLanguage(locale,'Contact Done By',languageData) ,
          //   dataIndex: 'contract_doneby',
          //   key: 'contract_doneby',
          //   render: (text, record,index) => ( 
          //     <div  style = {{padding:'2px',width:'100px'}}>
          //       {text}
        ...
        
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
                   {getValue(errortype_data,'value','label',text)} 
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Correction Log Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Correction Log Raw Data',languageData)} match={match} />
