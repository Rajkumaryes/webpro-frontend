...
import{ADHOCService} from '../../../../redux/MIS/adhoc/saga'
...
class QueryResolveSheet extends Component {
   ...
   fetchuser() {
    userService.fetchpermission_user('MIS QSC')
      .then((res) => {
         if(res.status)   { 
     ...
     fetchData() {
      ...
      if(user_id !== "" && date !=='' )
      {
        let date1=moment(convertUTCToLocalDate(date)).format('MM/DD/YYYY hh:mm:ss a')
          ...
          ADHOCService.fetchIndividualadhoc(user_id,date1)
          .then((res) => {
        ...
        const {date,adhoc_request_from,details,email_subject,timetaken,
            ...
            if(is_fill === true)
            {
                this.setState({
                  ...
                  ADHOCService.createadhoc(userid,date_n,adhoc_request_from,details,email_subject,timetaken,
    ...
    setValue(record)
{
   ...
   if(record !== null && record)
   {
      this.setState({
        ...
        adhoc_request_from:record.adhoc_request_from,
    ...
    render()
    {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'ADHOC',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'ADHOC',languageData)} match={match} />
            ...
            <div>
                <div className = "publishuser-card-component" style = {{padding:'10px',borderRadius:'10px',marginBottom:'15px'}}>
                    ...
                    <DatePicker
                        ...
                        <div className = "col-md-3 space-margin">
                            <Label  className = "fontstyle normal-font" >{onChangeLanguage(locale,'Request From',languageData)}
                            <a style = {{color :'red'}}>*</a></Label>
