...
import{reportService} from '../../../../redux/MIS/adhocrawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          checklist_data,teamdata} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Request From',languageData),
            dataIndex: 'adhoc_request_from',
            key: 'adhoc_request_from',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Severity',languageData),
            dataIndex: 'severity',
            key: 'severity',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'ADHOC Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'ADHOC Raw Data',languageData)} match={match} />
