...
import{reportService} from '../../../../redux/MIS/supportteamrawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          checklist_data,area_data,categorydata,misqscdata,reportfordata} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'MIS/QSC Tasks',languageData),
            dataIndex: 'mistasks',
            key: 'mistasks',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
              {getValue(misqscdata,'value','label',text)}      
              </div>),           
          },
          {
          ...
          {
            title: onChangeLanguage(locale,'Report For',languageData),
            dataIndex: 'reportfor',
            key: 'reportfor',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(reportfordata,'value','label',text)}     
              </div>),           
          },
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'MIS QSC Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'MIS QSC Raw Data',languageData)} match={match} />
