...
import{reportService} from '../../../../redux/asia/errorsheetrawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          teamdata,reportdata,regiondata} = this.state
        var columns= [
          {
          ...
          
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
                {getValue(reportdata,'value','label',text)} 
                {/* {text} */}
              </div>),           
          },
          {
          ...
          {
            title: onChangeLanguage(locale,'Error Reported',languageData),
            dataIndex: 'error_reported',
            key: 'error_reported',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
              {text}
          ...
          {
            title: onChangeLanguage(locale,'Error Email Timestamp',languageData),
            dataIndex: 'error_email',
            key: 'error_email',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
