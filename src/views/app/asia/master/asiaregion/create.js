...
createAPI(name,status)
{
  ...
  asiaerrorreportService.createasiaerrorreport(name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,status)
{
  ...
  asiaerrorreportService.updateasiaerrorreport(id,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
close(isedit)
{
  ...
  render()
  {
    ...
    const {name,region_data,isEdit,status,loading} = this.state
