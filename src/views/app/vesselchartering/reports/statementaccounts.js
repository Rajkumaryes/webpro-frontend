...
class QueryResolveSheet extends Component {
    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url =  'statementaccount',
            menu= 'Vessel Chartering' , 
            submenu='Statement of Accounts',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Statement of Accounts Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Statement of Accounts Raw Data',languageData)} match={match} />
