...
class QueryResolveSheet extends Component {
    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url =  'communicationmails',
            menu= 'Vessel Chartering' , 
            submenu='Communication Emails',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Communication Emails Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Communication Emails Raw Data',languageData)} match={match} />
