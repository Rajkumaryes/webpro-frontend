          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'retrivelpayment',
            menu= 'Vessel Chartering' , 
            submenu='Retrieval of Payment Advices',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Email Date /Time',languageData),
            dataIndex: 'email_datetime',
            key: 'email_datetime',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Retrieval of Payment Advices Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Retrieval of Payment Advices Raw Data',languageData)} match={match} />
