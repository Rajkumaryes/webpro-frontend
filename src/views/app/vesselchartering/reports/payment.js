...
class QueryResolveSheet extends Component {
          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'paymentadvicehire',
            menu= 'Vessel Chartering' , 
            submenu='Payment Advice Hire',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Payment Advice Hire Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Payment Advice Hire Raw Data',languageData)} match={match} />
