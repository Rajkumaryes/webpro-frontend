...
import{communicationmailsService} from '../../../../redux/vesselchartering/communicationemail/saga'
...
class QueryResolveSheet extends Component {
    ...
    onSubmit()
    {
        ...
        if(vessel_name !== "" &&  activity_type!== "" && week_no!== "" && email_datetime !== "")
        {
                ...
                communicationmailsService.createcommunicationmails(username,vessel_name,tat_time,
    ...
    render()
    {
        ...
        return (
            <>
              <title>{onChangeLanguage(locale,'Communication Emails',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Communication Emails',languageData)} match={match} />
