...
import{statementaccountService} from '../../../../redux/vesselchartering/statementaccounts/saga'
...
class QueryResolveSheet extends Component {
    ...
    onSubmit()
    {
        ...
        if(vessel_name !== "" &&  activity_type!== "" && week_no!== "" && email_datetime !== "")
        {
                ...
                statementaccountService.createstatementaccount(username,vessel_name,tat_time,
    ...
    render()
    {
        ...
        return (
            <>
              <title>{onChangeLanguage(locale,'Statement of Accounts',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Statement of Accounts',languageData)} match={match} />
