...
import{paymentadvicehireService} from '../../../../redux/vesselchartering/payment/saga'
...
class QueryResolveSheet extends Component {
    ...
    onSubmit()
    {
        ...
        if(vessel_name !== "" &&  activity_type!== "" && week_no!== "" && email_datetime !== "")
        {
                ...
                paymentadvicehireService.createpaymentadvicehire(username,vessel_name,tat_time,
    ...
    render()
    {
        ...
        return (
            <>
              <title>{onChangeLanguage(locale,'Payment Advice Hire',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Payment Advice Hire',languageData)} match={match} />
