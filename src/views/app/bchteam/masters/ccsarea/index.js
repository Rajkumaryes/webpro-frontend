...
      })
  ...
  onChangeFileUpload(files)
    ...
    ccsareaService.fileUpload(files[0])
      .then((res) => { 
        if(res.status)
        {
          this.setState({   
              ...
              <Colxx xxs="12">
                <div className = "row">
                    <div className = "col-md-7">
                        <Breadcrumb heading= {onChangeLanguage(locale,'CCS Area',languageData)} match={match} />
                    </div>
                    ...
                    {/* <Button className = "button-width" color="primary">
                       ...
                       <Button color = "primary"  className = 'fontstyle button-width' onClick ={(event) => this.openModal()}>
                        {onChangeLanguage(locale,' Add CCS Area',languageData)}
                      </Button>
                    </div>
    ...
    return (
        ...
        >
          <ModalHeader toggle={()=>this.closeModal()}>
              {isEdit ? onChangeLanguage(locale,'Update CCS Area',languageData) : onChangeLanguage(locale,'Create CCS Area',languageData)}   
          </ModalHeader>
          <ModalBody>
