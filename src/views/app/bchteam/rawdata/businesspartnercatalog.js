...
import{reportService} from '../../../../redux/bchteam/report/saga'
...
class QueryResolveSheet extends Component {
        ...
        matchcodetypeService.fetchapi()
          .then((res) => {
            ...
            if (res.status) {
              ...
              this.setState({
                matchcode_type_data: regionlist,
              })
          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'businesspartnercatalog',
            menu= 'BCH Team' , 
            submenu='BCH Team',
            type = 'Raw Data'
            if(is_report === true){
    ...
    onChangeTeam(value)
    {
        this.setState({  startdate  : '',enddate:'',user_data:[],data:[] })
  ...
  getamendmentvalue(id,array)
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          issuecode_data,category_data,matchcode_type_data,amendment_due_to_data,amendment_status_data,reason_data,assigned_to_data,cargo_type_data,} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Match Code',languageData),
          ...
          },
          {
            ...
            {
                title:onChangeLanguage(locale,'Matchcode Type',languageData) ,
                dataIndex: 'matchcode_type',
                key: 'matchcode_type',
                render: (text, record) => ( 
                  <div className="row d-flex justify-content-center" style = {{padding:'2px',width:'200px'}}>
                    {getValue(matchcode_type_data, 'value', 'label', text)} 
                  </div>),
              },
              {
              ...
              {
                title:onChangeLanguage(locale,'Pending Reason',languageData) ,
