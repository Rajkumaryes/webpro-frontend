        ...
        actioncategoryService.fetchapi()
          .then((res) => {
            ...
            if (res.status) {
              ...
              this.setState({
                actioncategory_data: regionlist,
              })
          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'contactcleanupservices',
            menu= 'BCH Team' , 
            submenu='BCH Team',
            type = 'Raw Data'
            if(is_report === true){
  ...
  getamendmentvalue(id,array)
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          actioncategory_data,comments_data,area_data,} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Contact Number',languageData),
          ...
          {
            title:onChangeLanguage(locale,'Action Category',languageData) ,
            dataIndex: 'action_category',
            key: 'action_category',
            render: (text, record) => ( 
              <div className="row d-flex justify-content-center" style = {{padding:'2px',width:'200px'}}>
                {getValue(actioncategory_data, 'value', 'label', text)} 
              </div>),
          },
            {
              ...
              },
              {
                ...
                render: (text, record) => ( 
                  <div className="row d-flex justify-content-center" style = {{padding:'2px',width:'200px'}}>
                    {getValue(comments_data, 'value', 'label', text)} 
                  </div>),
              },
              {
                title:onChangeLanguage(locale,'Self Audit',languageData) ,
                dataIndex: 'self_audit',
                key: 'self_audit',
                render: (text, record) => ( 
                  <div className="row d-flex justify-content-center" style = {{padding:'2px',width:'200px'}}>
                    {text}
