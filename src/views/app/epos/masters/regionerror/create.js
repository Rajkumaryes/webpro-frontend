...
createAPI(name,status)
{
  ...
  regionerrorService.createregionerror(name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,status)
{
  ...
  regionerrorService.updateregionerror(id,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
close(isedit)
{
  ...
  render()
  {
    ...
    const {name,isEdit,status,loading,regoindata} = this.state
      ...
      <div>
          ...
          <div>
            ...
            <Select  
                        ...
                        value={regoindata.filter(option =>(option.value).toLowerCase() === name.toLowerCase())}
                        options={regoindata}
