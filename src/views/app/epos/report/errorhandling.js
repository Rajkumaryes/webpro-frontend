    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url ='errorhandling',
            menu= 'EPOS' , 
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
                    ...
                    {
            title: onChangeLanguage(locale,'Equipment Number',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Events',languageData),
            dataIndex: 'events',
            key: 'events',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Events Date / Time',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Place of Act',languageData),
            dataIndex: 'place_of_act',
            key: 'place_of_act',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Issue Code',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Reported By',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Q',languageData),
            dataIndex: 'q',
            key: 'q',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Issue Level',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Creation Date',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Creation Time',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Claimed At',languageData),
            dataIndex: 'claimed_at',
            key: 'claimed_at',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {(text !== null && text !== '')  && moment(text).format('MM/DD/YYYY hh:mm')}
                </div>),           
          },
          {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Error HandlingRaw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Error HandlingRaw Data',languageData)} match={match} />
