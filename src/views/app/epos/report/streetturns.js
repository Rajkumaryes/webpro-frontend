    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url ='streetturns',
            menu= 'EPOS' , 
            submenu='Street Turns',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Stturn Code',languageData),
            dataIndex: 'stturn_code',
            key: 'stturn_code',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
             {getValue(stturnsdata,'value','label',text)}   
   
              </div>),           
          },
          {
            title: onChangeLanguage(locale,'Event Updated',languageData),
            dataIndex: 'event_updated',
            key: 'event_updated',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Event Deleted',languageData),
            dataIndex: 'event_deleted',
            key: 'event_deleted',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'No. of Checks',languageData),
            dataIndex: 'no_of_checks',
            key: 'no_of_checks',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'No. of Query',languageData),
            dataIndex: 'no_of_query',
            key: 'no_of_query',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'NE Purple Category',languageData),
            dataIndex: 'purple_category',
            key: 'purple_category',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Street TurnsRaw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Street TurnsRaw Data',languageData)} match={match} />
