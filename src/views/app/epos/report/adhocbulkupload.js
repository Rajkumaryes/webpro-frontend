    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url ='adhocbulk',
            menu= 'EPOS' , 
            submenu='Adhoc Bulk Upload',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'No. of Containers',languageData),
          ...
          {
            title: onChangeLanguage(locale,'POA',languageData),
            dataIndex: 'poa',
            key: 'poa',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Adhoc Bulkupload Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Adhoc Bulkupload Raw Data',languageData)} match={match} />
