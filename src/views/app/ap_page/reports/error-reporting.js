    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url =  'errorreporting',
            menu= 'AP' , 
            submenu='Error Reporting',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          region_data,area_data,error_type_data,gsc_comments_data,category_data,
          ...
          var  columns =[
            ...
            },
            {
              ...
              render: (text, record,index) => ( 
                <div  style = {{padding:'2px',width:'100px'}}>
                 { moment(record.date_reported).format('MM/DD/YYYY') }
                </div>),
            },
            {
            ...
            },
            {
              ...
              render: (text, record,index) => ( 
                <div  style = {{padding:'2px',width:'100px'}}>
                   {getValue(scanloaction_data,'value','label',text)}
                </div>),
            },
            {
            ...
            },
            {
              ...
              render: (text, record,index) => ( 
                <div  style = {{padding:'2px',width:'100px'}}>
                  {getValue(gsc_comments_data,'value','label',text)}
                </div>),
            },
            {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Error Reporting Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Error Reporting Raw Data',languageData)} match={match} />
