...
class MasterPage extends Component {
  ...
  renderTemplate()
  {
    ...
    var array = data.map(record=> {
      ...
            })
    return(
      <Workbook filename="Category.xlsx" element={<Button  className = "button-width" color="secondary">
    ...
    return (
        ...
        >
          <ModalHeader toggle={()=>this.closeModal()}>
              {isEdit ? onChangeLanguage(locale,'Update Category',languageData) : onChangeLanguage(locale,'Create Category',languageData)}   
          </ModalHeader>
          <ModalBody>
