  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Error Upload User ID',languageData),
            dataIndex: 'error_upload_user',
            key: 'error_upload_user',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Error Classification',languageData),
            dataIndex: 'error_classification',
          ...
          {
            title: onChangeLanguage(locale,'Dp voyage number',languageData),
            dataIndex: 'dp_voyage',
            key: 'dp_voyage',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Number of Dp voyage',languageData),
            dataIndex: 'no_of_dps',
            key: 'no_of_dps',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Error Occurred',languageData),
            dataIndex: 'error_occurred',
            key: 'error_occurred',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
