...
class InputAudit extends Component {
    ...
    onSubmit()
    {
        ...
        if(exception_issuedate !== "" &&  mtd_no !== "" &&  exception_no !== "" &&  
           receiver !== "" && capture_user !== "" &&shipper !== "" &&
            start_datetime !== "" &&  error !== "" &&  user_of_lastaction !== "" && 
            auditor_id !== "" && auditor_remarks !== "" && 
            solvedby_capture_user !== "" && exception_status !== "" )
        {
            ...
            instanceService.createapi(username,exception_issuedate,mtd_no,exception_no,subregion,errorcode,errorcode_group,receiver,area,
    ...
    onPaste()
    {
        clipboard.readText().then((text)=>{
            var record = getValue_1stInstance(text)
            ...
            <>
                ...
                <div className = "publishuser-card-component" style = {{borderRadius:'10px',marginBottom:'30px'}}>
                   ...
                   <div className = "col-md-3 space-margin">
                       ...
                       <div className = "col-md-3 space-margin">
                           <Label  className = "fontstyle normal-font" >{onChangeLanguage(locale,'Exception Status',languageData)}<a style = {{color :'red'}}>*</a></Label>
                           <Input   className = {is_submit === true && exception_status === ''?  "error-border-paste":"fontstyle text-background-paste" } 
                           placeholder = ''
                       ...
                       <div className = "col-md-3 space-margin">
                           <Label  className = "fontstyle normal-font" >{onChangeLanguage(locale,'Performed Action',languageData)}</Label>
                           <Input   className = {"fontstyle text-background-paste" } 
                           placeholder = ''
                       ...
                       <div className = "col-md-12 space-margin"  >
                            <Label  className = "fontstyle normal-font" >{onChangeLanguage(locale,'Issue Description',languageData)}</Label>
                            <textarea 
                            className = {"fontstyle textarea-background-paste" }  
                            placeholder = ''
