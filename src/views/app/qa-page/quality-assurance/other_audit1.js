...
import{otherauditsoneService} from '../../../../redux/qa/otherauditsone/saga'
import{otherscategoryService} from '../../../../redux/qa/otherscategory/saga'
import{inputerrorsubcategoryService} from '../../../../redux/qa/inputerrorsubcategory/saga'
import{tlacceptanceService} from '../../../../redux/qa/tlacceptance/saga'
import {getValue_OtherAudit1} from '../pasteData'
...
class InputAudit extends Component {
    ...
    fetchErrorCategory() {
        ...
        otherscategoryService.fetchapi()
          .then((res) => {
       ...
       fetchErrorSubCategory() {
        ...
        inputerrorsubcategoryService.fetchapi()
          .then((res) => {
              this.setState({loading:false})
             if(res.status)   { 
                let filterstatus = (res.data).filter(item => item.status === 1)
    ...
    onSubmit()
    {
        const {shipment_no,mtd_no,customer,medium,main_pod,main_pol,input_id,team,
        ...
        if(error !== "" &&  auditor_id !== "" && auditor_remarks !== "" && category!=='')
        {
            ...
            otherauditsoneService.createapi(username,shipment_no,mtd_no,customer,medium,main_pod,main_pol,input_id,team,
    ...
    onPaste()
    {
        clipboard.readText().then((text)=>{
            var record = getValue_OtherAudit1(text)
            ...
            <>
                ...
                <div className = "publishuser-card-component" style = {{borderRadius:'10px',marginBottom:'30px'}}>
                   ...
                   <div className = "col-md-3 space-margin">
                       ...
                       <div className = "col-md-3 space-margin">
                           <Label  className = "fontstyle normal-font" >{onChangeLanguage(locale,'Medium',languageData)}</Label>
                           <Input   className = {"fontstyle text-background-paste" } 
                           placeholder = ''
                           value = {medium}  
                       ...
                       <div className = "col-md-3 space-margin">
                           <Label  className = "fontstyle normal-font" > {onChangeLanguage(locale,'Error Sub Category',languageData)}</Label>
