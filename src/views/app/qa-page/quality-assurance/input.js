...
import{inputauditService} from '../../../../redux/qa/inputaudit/saga'
import{inputerrorcategoryService} from '../../../../redux/qa/inputerrorcategory/saga'
...
import {getValue_Inputaudit} from '../pasteData'
...
class InputAudit extends Component {
    ...
    fetchErrorCategory() {
        ...
        inputerrorcategoryService.fetchapi()
          .then((res) => {
    ...
    onSubmit()
    {
        const {shipment_no,mtd_no,customer,medium,main_pod,mtd_processed_date,input_id,team,
        ...
        if(shipment_no !== "" &&  mtd_no !== "" && mtd_processed_date !== "" &&    
        start_datetime !== "" &&  error !== "" &&  category !== "" && subcategory !== "" &&  auditor_id !== "" && 
            auditor_remarks !== "" )
        {
            ...
            inputauditService.createapi(username,shipment_no,mtd_no,customer,medium,main_pod,mtd_processed_date,input_id,team,
    ...
    onPaste()
    {
        clipboard.readText().then((text)=>{
            var record = getValue_Inputaudit(text)
