...
class InputAudit extends Component {
    ...
    render()
    {
        ...
        const {loading,chargecode_data,error_data,tl_acceptance_data,charge_applicable_data,standardcomment_data} = this.state
         var columns =  [
            {
            ...
            },
            {
              ...
              render: (text, record,index) => ( 
                <div  style = {{padding:'2px',width:'100px'}}>
                    {getValue(standardcomment_data,'value','label',text)} 
