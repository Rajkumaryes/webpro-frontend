...
class QueryResolveSheet extends Component {
  ...
  fetchregion() {
    ...
    onSubmit() { 
        const { user_id,regions,activity,remainders_email,startdate_time,enddate_time} = this.state;
        ...
        this.createAPI( username,regions,activity,remainders_email,startdate_time,end_datetime)
        }
        else
        {
          this.setState({
      ...
      createAPI(user_id,regions,activity,remainders_email,startdate_time,enddate_time)
      {
        trackandtraceService.createtrackandtrace(user_id,regions,activity,remainders_email,startdate_time,enddate_time)
          .then((res) => { 
            if(res.status)
              {
    ...
    render()
    {
        ...
        const {user_id,regions,activity,remainders_email,startdate_time,enddate_time,regiondata,indexing,indexingdata,is_submit,activitydata} = this.state
        return (
            <>
