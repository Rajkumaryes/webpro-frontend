...
import{reportService} from '../../../../redux/dgtt/dgerrorrawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Track & Trace/DG',languageData),
            dataIndex: 'track_trace',
            key: 'track_trace',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Booking',languageData),
            dataIndex: 'booking',
            key: 'booking',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Total Cargo/E-mail/Booking/Reminder',languageData),
            dataIndex: 'total_cargo_email_booking_reminder',
            key: 'total_cargo_email_booking_reminder',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Remark',languageData),
            dataIndex: 'remark',
            key: 'remark',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Error',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Error',languageData)} match={match} />
