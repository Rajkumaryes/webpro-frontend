...
import{reportService} from '../../../../redux/dgtt/dginputsheetrawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          areadata,dectypedata,cntrtypedata,inputstatusdata} = this.state
        var columns= [
          {
          ...
          },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(dectypedata,'value','label',text)} 
              </div>),           
          },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(cntrtypedata,'value','label',text)}   
              </div>),           
          },
          {
          ...
          },
          {
            ...
            dataIndex: 'mail_recived_datetime',
            key: 'mail_recived_datetime',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Input Status',languageData),
            dataIndex: 'input_status',
            key: 'input_status',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(inputstatusdata,'value','label',text)}   
              </div>),           
          },
          {
          ...
          {
            title: onChangeLanguage(locale,'Announcement Date & Time',languageData),
            dataIndex: 'announcement_datetime',
            key: 'announcement_datetime',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {(text !== null && text !== '')  && moment(text).format('MM/DD/YYYY hh:mm:ss a')}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Container No.',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Time Zone',languageData),
            dataIndex: 'timezone',
            key: 'timezone',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
