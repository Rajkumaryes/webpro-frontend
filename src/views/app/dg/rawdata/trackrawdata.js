...
import{reportService} from '../../../../redux/dgtt/dgtracktracerawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          regiondata,activitydata} = this.state
        var columns= [
          {
          ...
          },
          {
            ...
            dataIndex: 'remainders_email',
            key: 'remainders_email',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
