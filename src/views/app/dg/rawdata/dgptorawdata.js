...
import{reportService} from '../../../../redux/dgtt/dgptorawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          checklist_data,area_data,activitydata,regiondata} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Document Cut Off Time',languageData),
            dataIndex: 'document_cutoff_time',
            key: 'document_cutoff_time',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'No. of Booking',languageData),
            dataIndex: 'no_of_booking',
            key: 'no_of_booking',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'DGPTO',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'DGPTO',languageData)} match={match} />
