...
createAPI(name,status)
{
  ...
  containertypeService.createcontainertype(name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,status)
{
  ...
  containertypeService.updatecontainertype(id,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
      ...
      <div>
          ...
          <div>
            ...
            <Colxx xxs="8" className="mb-4">
                  <Input 
                        type="text"
                        placeholder = {onChangeLanguage(locale,'Container Type',languageData)} 
                        value = {name}  
