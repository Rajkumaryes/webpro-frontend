...
      })
      return(
        ...
        <Workbook filename="DG-PTO Region.xlsx" element={
  ...
  handleReset = clearFilters => {
    ...
    render()
    {
      const {locale,languageData,match} = this.props
        ...
        return (
            <>
            <title> {onChangeLanguage(locale,'DG-PTO Region',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <div className = "row">
                    <div className = "col-md-7">
                        <Breadcrumb heading= {onChangeLanguage(locale,'DG-PTO Region',languageData)} match={match} />
                    </div>
