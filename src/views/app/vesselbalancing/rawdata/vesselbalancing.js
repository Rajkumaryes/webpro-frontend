...
import{reportService} from '../../../../redux/mainlinefeeder/report/saga'
    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            report_url ='mainlinefeeder' ,
            submenu='Mainline Feeder',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          teamdata,areaselectiondata,ssydetailsdata,regiondata,activitydata,requesttypedata,
        ...
        var columns= [
          ...
          },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text == 1 ? 'IZM' : text == 2 ? 'MAA' : text == 3 ? 'BOM' : 'No'}
              </div>),           
          },
          {
          ...
          {
            title: onChangeLanguage(locale,'SSY Details',languageData),
            dataIndex: 'ssydetails',
            key: 'ssydetails',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(ssydetailsdata,'value','label',text)}    
              </div>),           
          },
          {
          ...
          {
            title: onChangeLanguage(locale,'Mail Received From',languageData),
            dataIndex: 'mailreceived_from',
            key: 'mailreceived_from',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Mail Received Date / Time',languageData),
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Mainline Feeder Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Mainline Feeder Raw Data',languageData)} match={match} />
