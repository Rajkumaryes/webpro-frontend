  ...
  render()
  {
    ...
    return (
      <div>
        ...
        {module !== 'Pending Follow-up Sheet' && module !=='Booking Amendment'&&
             <Row>
              <Colxx xxs="4" className="mb-4">
     ...
     {module === 'Pending Follow-up Sheet' &&
             <Row>
              <Colxx xxs="4" className="mb-4">
                   <Label> {onChangeLanguage(locale,'Name',languageData)}<a style = {{color :'red'}}>*</a></Label>
              </Colxx>
            ...
            <Select  
                        ...
                        classNamePrefix="react-select"
                        name="form-field-name"
                        value={exception_type_data.filter(option => option.value === name)}
   ...
   {module === 'Booking Amendment' &&
            ...
            <Select  
                        ...
                        classNamePrefix="react-select"
                        name="form-field-name"
                        value={amendment_medium_data.filter(option => option.value === name)}
