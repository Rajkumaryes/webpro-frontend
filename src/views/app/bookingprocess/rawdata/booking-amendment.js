          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const {username} = this.props
            const report_url =  'bookingamendment',
  ...
  getamendmentvalue(id,array)
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          issuecode_data,amendment_medium_data,amendment_type_data,amendment_induced_by_data,amendment_status_data,reason_data,assigned_to_data,cargo_type_data,} = this.state
        var columns= [
          {
          ...
          },
          {
            ...
            {
              title:onChangeLanguage(locale,'CSB Office',languageData),
