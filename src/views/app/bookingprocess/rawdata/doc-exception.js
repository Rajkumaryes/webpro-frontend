          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const {username} = this.props
            const report_url =  'exception',
            menu= 'DOC Exception' , 
            submenu='DOC Exception',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          regiondata,area_data,teamdata,exceptiondata,statusdata} = this.state
        var columns= [
          {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'DOC Exception',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'DOC Exception',languageData)} match={match} />
