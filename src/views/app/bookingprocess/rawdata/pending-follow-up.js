          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const {username} = this.props
            const report_url =  'pendingfollowup',
            menu= 'Pending Follow-up Sheet' , 
            submenu='Pending Follow-up Sheet',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          issuecode_data,action_type_data,exception_type_data} = this.state
        var columns= [
          {
