...
class QueryResolveSheet extends Component {
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,regiondata
         } = this.state
        var columns= [
          // {
          ...
          {
            title: onChangeLanguage(locale,'Number of Error/Instance',languageData),
            dataIndex: 'number_error',
            key: 'number_error',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Error Done By',languageData),
            dataIndex: 'error_done',
            key: 'error_done',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Error Sheet Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Error Sheet Raw Data',languageData)} match={match} />
