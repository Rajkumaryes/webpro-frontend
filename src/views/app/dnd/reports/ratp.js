  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'MHO',languageData),
            dataIndex: 'mho',
            key: 'mho',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Count of Contracts to be Checked',languageData),
            dataIndex: 'count',
            key: 'count',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'RATP Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'RATP Raw Data',languageData)} match={match} />
