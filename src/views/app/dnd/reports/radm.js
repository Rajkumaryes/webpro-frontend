...
import{reportService} from '../../../../redux/dnd/report/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          checklist_data,regiondata,subareadata} = this.state
        var columns= [
          {
          ...
          },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
                {getValue(subareadata,'value','label',text)}   
              </div>),           
          },
          {
            title: onChangeLanguage(locale,'Import Export',languageData),
            dataIndex: 'imports_export',
            key: 'imports_export',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Total to be Checked',languageData),
            dataIndex: 'total',
            key: 'total',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'File Name',languageData),
            dataIndex: 'filename',
            key: 'filename',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Trigger',languageData),
            dataIndex: 'trigger',
            key: 'trigger',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Re Export',languageData),
            dataIndex: 're_export',
            key: 're_export',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Re Use',languageData),
            dataIndex: 're_use',
            key: 're_use',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Blocked by RA',languageData),
            dataIndex: 'blocked_byra',
            key: 'blocked_byra',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Completed',languageData),
            dataIndex: 'completed',
            key: 'completed',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Missing Cases',languageData),
            dataIndex: 'missing_cases',
            key: 'missing_cases',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Wrong Sequence',languageData),
            dataIndex: 'wrong_seq',
            key: 'wrong_seq',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Duplications',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Others',languageData),
            dataIndex: 'others',
            key: 'others',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Tiggered But Color Not Changed',languageData),
            dataIndex: 'triggered',
            key: 'triggered',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Queries',languageData),
            dataIndex: 'queries',
            key: 'queries',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Amount in USD',languageData),
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'RADM Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'RADM Raw Data',languageData)} match={match} />
