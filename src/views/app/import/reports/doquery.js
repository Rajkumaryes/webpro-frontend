          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'deliveryorder',
            menu= 'Imports' , 
            submenu='Delivery Order Query',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Previous TAT',languageData),
            dataIndex: 'previous_tat',
            key: 'previous_tat',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
              {text}  
          ...
          {
            title: onChangeLanguage(locale,'New TAT',languageData),
            dataIndex: 'new_tat',
            key: 'new_tat',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Total TAT',languageData),
            dataIndex: 'total_tat',
            key: 'total_tat',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Delivery Order Query Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Delivery Order Query Raw Data',languageData)} match={match} />
