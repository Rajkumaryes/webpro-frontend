    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url =  'invoicecancellation',
            menu= 'Imports' , 
            submenu='Invoice Cancellation Import',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          reason_code_data,area_data,accepted_data} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Invoice Date',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Invoice Currency',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Invoice Amount',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Invoice Creator',languageData),
            dataIndex: 'invoice_creater',
            key: 'invoice_creater',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Reason Code1',languageData),
            dataIndex: 'reasoncode',
            key: 'reasoncode',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(reason_code_data,'value','label',text)}    
              </div>),           
          },
          {
            title: onChangeLanguage(locale,'Reason Remarks',languageData),
            dataIndex: 'reason_remarks',
            key: 'reason_remarks',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Original Invoice Number',languageData),
            dataIndex: 'orginal_invoice_no',
            key: 'orginal_invoice_no',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Accepted/Refuted',languageData),
            dataIndex: 'invoice_type',
            key: 'invoice_type',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(accepted_data,'value','label',text)}    
              </div>),           
          },
          {
          ...
          {
            title: onChangeLanguage(locale,'Captured ID',languageData),
            dataIndex: 'capturedid',
            key: 'capturedid',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Invoice Cancellation Import Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Invoice Cancellation Import Raw Data',languageData)} match={match} />
