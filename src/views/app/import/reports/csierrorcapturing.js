          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'csierror',
            menu= 'Imports' , 
            submenu='CSI Error Capturing',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          activity_data,subactivity_data,errorcode_data,region_data,area_data} = this.state
        var columns= [
          {
          ...
          },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
              {getValue(errorcode_data,'value','label',text)}  
              </div>),           
          },
          {
            title: onChangeLanguage(locale,'Count of Error',languageData),
          ...
          },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
              {getValue(subactivity_data,'value','label',text)}  
              </div>),           
          },
          {
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'CSI Error Capturing Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'CSI Error Capturing Raw Data',languageData)} match={match} />
