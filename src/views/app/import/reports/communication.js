    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
          if ((Date.parse(enddate) > Date.parse(startdate)))
          {
            ...
            const report_url =  'communicationsheet',
            menu= 'Imports' , 
            submenu='Communication Sheet',
            type = 'Raw Data'
    ...
    render()
    {
        ...
        var columns= [
          ...
          },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(customtype_data,'value','label',text)}    
              </div>),           
          },
          {
            title: onChangeLanguage(locale,'Shipment Number',languageData),
            dataIndex: 'no_shipment',
            key: 'no_shipment',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Communication Sheet Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Communication Sheet Raw Data',languageData)} match={match} />
