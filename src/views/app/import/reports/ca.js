...
import{reportService} from '../../../../redux/imports/report/saga'
          ...
          if(res.status === true)
            {
                ...
                var list = res.data.map(function(areaaval) {
                  return  {label : areaaval.activity ,value : (areaaval.id).toString()};
                  });
              this.setState({ 
                  activity_data:list  ,        
              }) 
          ...
          if ((Date.parse(enddate) > Date.parse(startdate)))
           {
            ...
            const report_url =  'csiproductivity',
            menu= 'Imports' , 
            submenu='CSI Productivity',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
          activity_data,area_data} = this.state
        var columns= [
          {
          ...
          },
          {
            ...
            dataIndex: 'day_of_activity',
            key: 'day_of_activity',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               { getValue(activity_data,'value','label',text)}    
              </div>),           
          },
          {
          ...
          {
            title: onChangeLanguage(locale,'Count',languageData),
            dataIndex: 'count',
            key: 'count',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'No. of MTD',languageData),
            dataIndex: 'no_of_mtd',
            key: 'no_of_mtd',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          // {
          //   title: onChangeLanguage(locale,'Pre-pond',languageData),
          //   dataIndex: 'pre_pond',
          //   key: 'pre_pond',
          //   render: (text, record,index) => ( 
          //     <div  style = {{padding:'2px',width:'100px'}}>
          ...
          // },
          // {
          //   title: onChangeLanguage(locale,'Pending',languageData),
          //   dataIndex: 'pre_pond',
          //   key: 'pre_pond',
          //   render: (text, record,index) => ( 
          //     <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Total Unit',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Vessel Date',languageData),
            dataIndex: 'vessel_date',
            key: 'vessel_date',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'CSI Productivity Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'CSI Productivity Raw Data',languageData)} match={match} />
