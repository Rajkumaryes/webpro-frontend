...
onSubmit() { 
  ...
  console.log("lkgljk region_id " ,region_id)
  console.log("lkgljk area_name " ,area_name)
...
createAPI(region_id,area_name,status)
{
  ...
  areaimportService.createareaimport(region_id,area_name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,region_id,area_name,status)
{
  ...
  areaimportService.updateareaimport(id,region_id,area_name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
close(isedit)
{
  ...
  render()
  {
    ...
    const {region_id,area_name,team_data,region_data,isEdit,status,loading} = this.state
      ...
      <div>
        ...
        <Row>
            ...
            <Select  
                        ...
                        classNamePrefix="react-select"
                        name="form-field-name"
                        value={team_data.filter(option =>(option.value).toLowerCase() === area_name.toLowerCase())}
                        options={team_data}
