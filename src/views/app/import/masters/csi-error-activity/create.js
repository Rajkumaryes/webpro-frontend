...
createAPI(name,unit,status)
{
  this.setState({
    loading : true
  })
  csierroractivityService.createcsierroractivity(name,unit,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,unit,status)
{
  this.setState({
    loading : true
  })
  csierroractivityService.updatecsierroractivity(id,name,unit,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
