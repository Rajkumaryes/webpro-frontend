...
createAPI(name,region,eq,status)
{
  ...
  crmactivityService.createcrmactivity(name,region,eq,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,region,eq,status)
{
  ...
  crmactivityService.updatecrmactivity(id,name,region,eq,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
onChangeRegion(value)
{
  ...
  render()
  {
    ...
    const {region,name,region_data,eq,isEdit,status,loading} = this.state
