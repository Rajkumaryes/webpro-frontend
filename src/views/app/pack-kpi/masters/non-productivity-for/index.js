...
class MasterPage extends Component {
  ...
  renderTemplate()
  {
    ...
    var array = data.map(record=> {
      ...
            })
    return(
      <Workbook filename="For.xlsx" element={<Button  className = "button-width" color="secondary">
  ...
  handleReset = clearFilters => {
    ...
    render()
    {
      const {locale,languageData,match} = this.props
        ...
        return (
            <>
            <title> {onChangeLanguage(locale,'For-(Non-Productivity Hours)',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <div className = "row">
                    <div className = "col-md-8">
                        <Breadcrumb heading= {onChangeLanguage(locale,'For-(Non-Productivity Hours)',languageData)} match={match} />
                    </div>
                    <div className = "col-md-4">
                        ...
                        {onChangeLanguage(locale,' Add For',languageData)}
                      </Button>
                    </div>
                </div>
