...
import{eqmasterService} from '../../../../../redux/pack-kpi/eqmaster/saga'
...
class RegisterUser extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      loading:false,
      module_data:[
        {label : 'Productivity EH Finding' ,value : 'Productivity EH Finding'},
        {label : 'Productivity Without EH' ,value : 'Productivity Without EH'},
        {label : 'Productivity With EH' ,value : 'Productivity With EH'},
        {label : 'Productivity Audit' ,value : 'Productivity Audit'},
      ],
    };
  }
