...
createAPI(name,status)
{
  ...
  errorreceivedbyService.createapi(name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,status)
{
  ...
  errorreceivedbyService.updateapi(id,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
close(isedit)
{
  ...
  render()
  {
    ...
    const {name,isEdit,status,loading,user_data} = this.state
          ...
          <div>
            ...
            <Input 
                    ...
                    {/* <Select  
                      ...
                      value={user_data.filter(option =>option.value === name)}
                      options={user_data}
                      onChange={(option)=>this.setState({name:option.value})}
                      /> */}
