...
import{productivityService} from '../../../../redux/pack-kpi/productivity_withouteh/saga'
...
class QueryResolveSheet extends Component {
    ...
    onSubmit()
    {
        const {analysis_done_week,document_no,shipment_no,
            start_time,updated_start_time,remarks} = this.state
        ...
        if(analysis_done_week !== "" &&   document_no !== "" &&   shipment_no !== "" )
        {
          const end_time =   new Date() ,updated_end_time = new Date()
            ...
            productivityService.createapi(username,analysis_done_week,document_no,shipment_no,
  ...
  handleKeypress (e) {
    ...
    render()
    {
        ...
        const {analysis_done_week,document_no,shipment_no,
           start_time,end_time,remarks,is_submit,loading} = this.state
        return (
            <>
            <title>{ onChangeLanguage(locale,'Productivity Without EH',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Productivity Without EH',languageData)} match={match} />
