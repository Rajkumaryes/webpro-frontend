...
import {reportService} from '../../../../redux/pack-kpi/report/saga'
...
class QueryResolveSheet extends Component {
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,error_type_data} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Data Week No',languageData),
            dataIndex: 'week_no',
            key: 'week_no',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Error Marked By',languageData),
            dataIndex: 'error_markedby',
            key: 'error_markedby',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,'Error Received By',languageData),
            dataIndex: 'error_receivedby',
            key: 'error_receivedby',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Error Received Date',languageData),
            dataIndex: 'error_received',
            key: 'error_received',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
