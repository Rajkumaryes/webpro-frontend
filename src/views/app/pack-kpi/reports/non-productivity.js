...
class QueryResolveSheet extends Component {
    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
            ...
            const report_url =  'nonproductivity',
            menu= 'PACT KPI' , 
            submenu='Non-Productivity Hours',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        const {enddate,startdate,team_id,team_data,is_submit,loading,data,page,pageSize,
            categorydata,for_data} = this.state
        var columns= [
          {
          ...
          {
            title: onChangeLanguage(locale,'Total Time',languageData),
            dataIndex: 'totaltime',
            key: 'totaltime',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          },
          {
            ...
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {getValue(for_data,'value','label',text)}    
              </div>),           
          },
          {
          ...
          {
            title: onChangeLanguage(locale,'Non-Productive Task Description',languageData),
            dataIndex: 'nonproductive_description',
            key: 'nonproductive_description',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Non-Productivity Hours Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Non-Productivity Hours Raw Data',languageData)} match={match} />
