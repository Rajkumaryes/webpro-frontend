...
class QueryResolveSheet extends Component {
    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
            ...
            const report_url =  'productivityehfinding',
            menu= 'PACT KPI' , 
            submenu='Productivity EH Finding',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'EH Reason Code',languageData),
          ...
          {
            title: onChangeLanguage(locale,'EH Status',languageData),
            dataIndex: 'eh_status',
            key: 'eh_status',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Productivity EH Finding Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Productivity EH Finding Raw Data',languageData)} match={match} />
