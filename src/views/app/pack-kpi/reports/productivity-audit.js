...
class QueryResolveSheet extends Component {
    ...
    fetchPagination(page,per_page,startdate,enddate,is_report)
    {
        ...
        if(enddate !== "" && startdate !== ""  && team_id !== "")
        {
            ...
            const report_url =  'productivityaudit',
            menu= 'PACT KPI' , 
            submenu='Productivity Audit',
            type = 'Raw Data'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Exception Available',languageData),
            dataIndex: 'exception_availble',
            key: 'exception_availble',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
              {text}  
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Analysis Done For Week',languageData),
            dataIndex: 'analysis_done_week',
            key: 'analysis_done_week',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Productivity Audit Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Productivity Audit Raw Data',languageData)} match={match} />
