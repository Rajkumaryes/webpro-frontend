...
import{reportService} from '../../../../redux/bookingamendment/productivityreport/saga'
...
class QueryResolveSheet extends Component {
     ...
     fetchPagination(page,per_page,startdate,enddate,is_report)
     {
         ...
         if(enddate !== "" && startdate !== ""  && team_id !== "")
         {
           if ((Date.parse(enddate) > Date.parse(startdate)))
           {
             ...
             const menu= 'Booking Amendment' , 
             submenu='Booking Amendment',
             type = 'Productivity Report'
 
             if(is_report == true){
 
             reportService.fetchapidownload(page,per_page,startdate,enddate,user_data,is_report,
               ...
               if(res.status)
                 {
                   if(res.report)
                   {
                     createNotification(res.message,'success','filled');
                   }
  ...
  if(team_id !== '')
  {
    ...
    this.fetchPagination(1,10, new Date(finalDate),convertLocalToUTCDate(new Date()),false)
  }
  else
  {
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'Errors',languageData),
            dataIndex: 'errors',
            key: 'errors',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,' Omni Case Handling',languageData),
            dataIndex: 'omni_case_handling',
            key: 'omni_case_handling',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,' Omni Case Merging',languageData),
            dataIndex: 'omni_case_merging',
            key: 'omni_case_merging',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,' Unassigned list',languageData),
            dataIndex: 'unassigned_list',
            key: 'unassigned_list',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
          ...
          {
            title: onChangeLanguage(locale,' Workorder Removal',languageData),
            dataIndex: 'workorder_removal',
            key: 'workorder_removal',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,' Internal Audit',languageData),
          ...
          {
            title: onChangeLanguage(locale,' Email Escalation',languageData),
            dataIndex: 'email_escalation',
          ...
          {
            title: onChangeLanguage(locale,' Total Units derrived from process',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Present Days',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Target units Excluding Non productive (Non Process)',languageData),
            dataIndex: 'present_Working_days',
            key: 'present_Working_days',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'EQ Target/day',languageData),
            dataIndex: 'eQ_Target',
            key: 'eQ_Target',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Target Units',languageData),
          ...
          {
            title: onChangeLanguage(locale,'Non Productive Mins',languageData),
            dataIndex: 'non_Productive_Minutes',
            key: 'non_Productive_Minutes',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Non Productivity - Non Process(EQ)',languageData),
            dataIndex: 'non_Productive_Units_nonprocess',
            key: 'non_Productive_Units_nonprocess',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Non Productivity - Process (EQ)',languageData),
            dataIndex: 'non_Productive_Units_process',
            key: 'non_Productive_Units_process',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Total Units with Non Productive Units (Process)',languageData),
            dataIndex: 'total_Units_with_NP',
            key: 'total_Units_with_NP',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Total Counts',languageData),
            dataIndex: 'total_Counts',
            key: 'total_Counts',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
          ...
          {
            title: onChangeLanguage(locale,'Actuals Units Achieved',languageData),
            dataIndex: 'per_day_achived_Units',
            key: 'per_day_achived_Units',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}
              </div>),           
          ...
          {
            title: onChangeLanguage(locale,'Accuracy(%)',languageData),
            dataIndex: 'accuracy',
            key: 'accuracy',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
          ...
          {
            title: onChangeLanguage(locale,'Productivity(%)',languageData),
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Productivity Report',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Productivity Report',languageData)} match={match} />
