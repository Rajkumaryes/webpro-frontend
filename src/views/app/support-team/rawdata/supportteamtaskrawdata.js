...
import{reportService} from '../../../../redux/supportteam/supportteamadhocrawdata/saga'
  ...
  paginationOptions = {
    ...
    render()
    {
        ...
        var columns= [
          ...
          {
            title: onChangeLanguage(locale,'ADHOC Request From',languageData),
            dataIndex: 'adhoc_request',
            key: 'adhoc_request',
            render: (text, record,index) => ( 
              <div  style = {{padding:'2px',width:'100px'}}>
               {text}    
        ...
        return (
            <>
            <title>{onChangeLanguage(locale,'Task Delievered Raw Data',languageData)}</title>
            <Row>
              <Colxx xxs="12">
                <Breadcrumb heading={onChangeLanguage(locale,'Task Delievered Raw Data',languageData)} match={match} />
