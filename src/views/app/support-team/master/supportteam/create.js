...
createAPI(name,status)
{
  ...
  SupportteamService.createsupportteam(name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
updateAPI(id,name,status)
{
  ...
  SupportteamService.updatesupportteam(id,name,status)
    .then((res) => { 
      this.setState({   
        loading : false     
      }) 
...
close(isedit)
{
  ...
  render()
  {
    ...
    const {name,team_data,isEdit,status,loading} = this.state
